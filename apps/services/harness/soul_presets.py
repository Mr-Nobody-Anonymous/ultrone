...
# Monorepo note: soul preset .md files live in the data/ bucket, organized as
# data/<category>/<preset>.md (16 category dirs). The loader rglobs *.md from
# here and derives the category from md_file.parent.name.
_PRESETS_DIR = _find_repo_root(Path(__file__)) / "data"
