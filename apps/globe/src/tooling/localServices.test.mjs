...
import { overpassProxy } from 'ultrone-globe/server/providers/overpass';
import { militaryInstallationsProxy } from 'ultrone-globe/server/providers/military-installations';
import {
  regionalBriefProxy,
  weatherEffectsProxy,
} from 'ultrone-globe/server/providers/regional';
import { openAiRealtimeProxy } from 'ultrone-globe/server/providers/openai';
import { keySetupEndpoint } from 'ultrone-globe/server/standalone/key-setup';
