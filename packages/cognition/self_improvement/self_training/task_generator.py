...
class LevelSpec:
    ...
    def sample(
        self, index: int, *, prefix: str, seed: Optional[int] = None
    ) -> TaskProfile:
        ...
        return TaskProfile(
            ...
            tool_requirement=(
                round(rng.uniform(*self.tool_requirement), 4)
...
def default_curriculum() -> List[LevelSpec]:
    ...
    return [
        LevelSpec(
            ...
            difficulty=(0.05, 0.35),
            reasoning_depth=(0.05, 0.30),
        ...
        LevelSpec(
            ...
            difficulty=(0.20, 0.50),
            reasoning_depth=(0.10, 0.45),
            latency_sensitivity=(0.4, 0.9),
            num_tasks=10,
        ),
        LevelSpec(
            name="multiple_objectives",
            description="tools plus deeper reasoning chains",
            difficulty=(0.40, 0.70),
            reasoning_depth=(0.45, 0.80),
            tool_probability=0.85,
            num_tasks=10,
        ),
        LevelSpec(
            name="fault_recovery",
            ...
            reasoning_depth=(0.55, 0.90),
            context_requirement=(0.60, 0.98),
            num_tasks=10,
        ),
        LevelSpec(
            name="unseen_environments",
            description="mixed hard regimes including private work",
            difficulty=(0.65, 0.95),
            reasoning_depth=(0.60, 0.95),
            context_requirement=(0.30, 0.95),
            tool_probability=0.6,
            privacy_probability=0.25,
            num_tasks=10,
        ),
    ]
