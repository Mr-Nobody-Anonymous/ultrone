...
Inspired by SuperAGI's performance telemetry loop that analyzes failures
to optimize prompt steps and tool executions.

Features:
- Action-level success/failure tracking
- Response time analysis
- Failure pattern detection
- Automatic fitness scoring against genome
- Cross-domain performance aggregation
"""
...
logger = logging.getLogger("Ultrone.Evolution.Telemetry")
...
class PerformanceTelemetry:
    ...
    def log_action(
        ...
        fitness = max(0.0, base_fitness - time_penalty)
