...
# Monorepo note: this file now lives at packages/cognition/brain/orchestrator.py,
# so walking up a fixed number of parents no longer reaches the repo root.
# Walk up until pyproject.toml is found (the repo-root marker), and keep
# runtime artifacts under the data/ bucket (data/memory/).
...
# Default paths (runtime artifacts live in the data/ bucket)
