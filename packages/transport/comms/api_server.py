...
# Default output path for briefings (runtime artifacts live in the data/ bucket)
BRIEFING_LOG_PATH = _find_repo_root(Path(__file__)) / "data" / "memory" / "commander_log.txt"
