...
class ResourceAllocator:
    ...
    def _find_best_unit(self, contact: Contact, units: List[Unit]) -> Optional[Unit]:
    ...
    def _select_weapon(self, unit: Unit, contact: Contact) -> str:
    ...
    def _calculate_effect(self, weapon: str, contact: Contact) -> float:
