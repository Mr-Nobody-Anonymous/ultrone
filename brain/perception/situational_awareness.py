...
class SituationalAwareness:
    ...
    def update(self, feeds: List, units: List[Unit]) -> List[COPContact]:
        """
    ...
    def get_threatening_contacts(self, min_level: ThreatLevel = ThreatLevel.MEDIUM) -> List[COPContact]:
    ...
    def get_contacts_by_domain(self, domain: DomainType) -> List[COPContact]:
